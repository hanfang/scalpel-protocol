...
python single-vcf-filter.py -i denovo.twopass.vcf.ms.out.hq.NA12882.vcf -mc 10 -chi 10.8 -o denovo.twopass.vcf.ms.out.hq.NA12882.filter.vcf
...
awk '{if($2=="frameshift") print}' denovo.twopass.vcf.ms.out.hq.NA12882.filter.hg19_popfreq_max_20150413_filtered.exonic_variant_function > denovo.twopass.vcf.ms.out.hq.NA12882.filter.hg19_popfreq_max_20150413_filtered.exonic_variant_function.fs.txt
